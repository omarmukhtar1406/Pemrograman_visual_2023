...
Public Class FormPenyewa
    ...
    Private Sub TambahData()
        ...
        Dim id_mobil As String = txtIDKAMAR.Text
        ...
        Dim postData As String = $"nama_penyewa={nama_penyewa}&telepon={telepon}&id_mobil={id_mobil}&harga={harga}&tanggal_checkin={tanggal_checkin}&tanggal_checkout={tanggal_checkout}&jumlah_malam={jumlah_malam}&total_biaya={total_biaya}"
                ...
                Finally
                    If (penyewa_baru = False) Then
                        ...
                        For Each mydata As Penyewa In data
                            ...
                            txtIDKAMAR.Text = mydata.id_mobil
    ...
    Private Sub txtIDKAMAR_TextChanged(sender As Object, e As EventArgs) Handles txtIDKAMAR.TextChanged
        ...
        Dim id_mobil As String = txtIDKAMAR.Text
        Using client As New HttpClient()
            Dim response As HttpResponseMessage = client.GetAsync(kamar_api & "?id_mobil=" & id_mobil).Result
            If response.IsSuccessStatusCode Then
                Dim jsonString As String = response.Content.ReadAsStringAsync().Result
                Try
    ...
    Private Sub txtNMPENYEWA_TextChanged(sender As Object, e As EventArgs) Handles txtNMPENYEWA.TextChanged
